...
defined('WEB_PATH') ||
define('WEB_PATH','http://192.168.0.107/alatcamagazin-next');

define('CK_BASE_PATH','/alatcamagazin-next');
...
define('NEWS_IMAGE_PATH','D:/xampp/htdocs/alatcamagazin-next/public/uploads/news/');
